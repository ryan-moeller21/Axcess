 ...
 * @param {String} passwordConfirmation If defined, it's a register attempt. Otherwise it's a login attempt.
 */
 ...
 * @param {String} email  Email entered by the user.
 * @param {String} password Password entered by the user.
 * @param {String} resolve Callback function to call when we successfully complete the action for the promise.
 * @param {String} reject Callback function to call when we encounter failure.
 */
